...
float drawCross(vec2 loc, vec2 size, vec2 coord){
...
void main() {
  ...
  coord = coord*rotate2d(time*5.0); //left hand direction
  coord = coord * sin(time); //scale

  vec3 colorData = vec3(drawCross(vec2(0.0), vec2(0.2, 0.02), coord));
